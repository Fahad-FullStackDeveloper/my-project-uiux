      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-4 grid-rows-1 gap-10">
          ...
          <div className="col-span-1 row-span-1 relative">
            {/* Image */}
            <Image
              src="/images/Chef card1.png" // Replace with your image URL
              alt="Dish 5"
          ...
          <div className="col-span-1 row-span-1">
            <Image
              src="/images/Chef card2.png" // Replace with your image URL
              alt="Dish 6"
              className="w-full h-full object-cover rounded-lg shadow-lg"
            />
          </div>
          ...
          <div className="col-span-1 row-span-1">
            <Image
              src="/images/Chef card3.png" // Replace with your image URL
              alt="Dish 7"
              className="w-full h-full object-cover rounded-lg shadow-lg"
            />
          </div>
          ...
          <div className="col-span-1 row-span-1">
            <Image
              src="/images/Chef card4.png" // Replace with your image URL
              alt="Dish 8"
              className="w-full h-full object-cover rounded-lg shadow-lg"
            />
          </div>
